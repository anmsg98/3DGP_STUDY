...
{
	_tcscpy_s(m_pszFrameRate, _T("2017180037 ("));
}
...
bool CGameFramework::OnCreate(HINSTANCE hInstance, HWND hMainWnd)
{
	...
	BuildObjects();
	PlaySound(NULL, 0, 0);
	PlaySound(TEXT("Resource/bgm.wav"), 0, SND_FILENAME | SND_ASYNC | SND_LOOP);
...
void CGameFramework::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam) {
	...
	case WM_KEYUP:
		...
		case VK_RETURN:
			break;
		case VK_CONTROL:
			((CTerrainPlayer*)m_pPlayer)->FireBullet(m_pSelectedObject);
			break;
		case VK_F8:
			break;
		case VK_F9:
